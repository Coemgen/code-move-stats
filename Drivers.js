...
function sendMonthlyOhsStatsReminder() {
  ...
  var folderData = DriveApp.getFolderById(
  ...
  var body = "<p>Click the following link to access the sheet: "
    + "<a href=\"{file.getUrl}\">{file.getName}</a></p>";
  body += "<p>If you see #REF! in the cell, click the cell, and then"
    + " click Allow Access to connect the data.</p>";
  body += "<p>Please enter all non-automated data values.</p>";
  body += "<p>If you have any questions/comments, please contact"
    + " James E Burns or Kevin Griffin.</p>";
