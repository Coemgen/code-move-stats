...
const MonthlyRun = (
  ...
  function (
    ...
    function addSupTechFormulas(yearlyStatsSs, yearStr) {
      const weekendDaysSheet = yearlyStatsSs.getSheetByName("Weekdend Days");
